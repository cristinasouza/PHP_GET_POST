...
<body>
    <?php 
      $nome    = $_POST["name"];    // obtém dado enviado do form e atribui a variável 
      $email   = $_POST["email"];   // obtém dado enviado do form e atribui a variável
      $celular = $_POST["celular"]; // obtém dado enviado do form e atribui a variável
      $agree   = $_POST["agree-term"]; // obtém dado enviado do form e atribui a variável
      $data    = $_POST["dt_nasc"]; // obtém dado enviado do form e atribui a variável
    ...
    <div class="content">
        ...
        <h4 class="formType">Dados recebidos via method="POST"</h4>
        <p><b>PHP</b> recebe os dados enviados via <b>POST</b> de um Form HTML</p>
